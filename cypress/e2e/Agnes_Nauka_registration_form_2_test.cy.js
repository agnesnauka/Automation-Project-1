...
describe('Section 1: Functional tests', () => {
    ...
    it('User can use only same both first and validation passwords', ()=>{
        ...
        cy.get('[data-cy="name"]').type('Agnes')
        cy.get('[data-testid="lastNameTestId"]').type('Nauka')
        ...
        //Change the test so that passwords match
        //In order to write new password, old one should be deleted first
    ...
    it('User can submit form with all fields added', ()=>{
        ...
        cy.get('[data-cy="name"]').type('Agnes')
        cy.get('[data-testid="lastNameTestId"]').type('Nauka')
        cy.get('[for="htmlFavLanguage"]').click()
        cy.get('[for="vehicle1"]').click()
    ...
    it('User cannot submit form without a mandatory field', ()=>{
        ...
        // Assert that input error message is shown
...
describe('Section 2: Visual tests', () => {
    ...
    it('My test for second picture', () => {
        ...
        // get element and check its parameter height, to less than 116 and greater than 80
    ...
    it('Check that check boxes list is correct', () => {
        ...
        // Selecting one will not remove selection from other checkbox
